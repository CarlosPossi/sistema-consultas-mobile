              ...
              <>
                ...
                {pacientes.map((paciente) => (
                  <View key={paciente.id} style={styles.card}>
                    ...
                    <Text style={styles.cardInfo}>Sexo: {paciente.sexo}</Text>
                    <Text style={styles.cardInfo}>
                      Data de Nascimento: {paciente.dataDeNascimento}
                    </Text>
                    <Text style={styles.cardInfo}>Idade: {paciente.idade}</Text>
                    <Text style={styles.cardInfo}>Endereço: {paciente.endereco}</Text>
                    <Text style={styles.cardInfo}>CPF: {paciente.cpf}</Text>
                    <Text style={styles.cardInfo}>Email: {paciente.email}</Text>
                    {paciente.telefone && (
                      <Text style={styles.cardInfo}>
